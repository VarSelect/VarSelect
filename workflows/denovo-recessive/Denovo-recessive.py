...
"""
    ...
    Region: chr 1 ~ 22
            chr X:
                nonPAR -> no matter child is son or daughter
...
def main(argv):
    ...
    for i in range(len(vlist)):
        ...
        if not(is_F) and not(is_M):
            if not(nonPAR):
                if is_HOM(child) and c1 not in father and c1 not in mother:
                    print (true)
                else:
                    print (false)
            else:
                if gender:
                    if child != father and child not in mother:
                        print (true)
                    else:
                        print (false)
                else:
                    if is_HOM(child) and child[0] != father and child[0] not in mother:
                        print (true)
                    else:
                        print (false)
        ...
        # 2. Father is affected, mother is unaffected and child is son
            ...
            if not(nonPAR):
                if is_HOM(child) and is_HOM(father) and c1 not in father and c1 not in mother and father != mother:
                    print (true)
                else:
                    print (false)
            else:
                if child != father and child not in mother and father not in mother:
                    print (true)
                else:
                    print (false)
        ...
        # 3. Father is unaffected, mother is affected and child is son
            ...
            if not(nonPAR):
                if is_HOM(child) and is_HOM(mother) and c1 not in father and c1 not in mother and father != mother:
                    print (true)
                else:
                    print (false)
            else:
        ...
        # 4. Father is affected, mother is unaffected and child is daughter
            ...
            if not(nonPAR):
                if is_HOM(child) and is_HOM(father) and child != father and c1 not in mother and father != mother:
                    print (true)
                else:
                    print (false)
            else:
                if is_HOM(child) and child[0] != father and child[0] not in mother and father not in mother:
                    print (true)
                else:
                    print (false)
        ...
        # 5. Father is unaffected, mother is affected and child is daughter
            ...
            if not(nonPAR):
                if is_HOM(child) and is_HOM(mother) and child != father and c1 not in mother and father != mother:
                    print (true)
                else:
                    print (false)
            else:
